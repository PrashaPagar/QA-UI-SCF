...
describe("Pending Settlement flow--->", () => {
let config;
...
it("Open Facility---> Push Invoices", () => {
  ...
  cy.get('[data-qa-id="edit-button"]').click()
  adminObj.selectInvoices()
...
// //--------------- Admin login for funding request---------------//
...
//     adminObj.fundingRequestPageDetails(); // Funding page request details
//     cy.reload()
//     adminObj.invoiceStateFundingRequested() // Transaction and Invoice state validations
//     singout.singOutUser(config.AdminUser);
//   })

//   //----------------Funder Login- to accept transaction-------//
//    it("Login as an Funder ---> Accept Transaction", () => {
...
//     funderObj.funderTransactionPageDetails()
//     funderObj.invoiceStateFundingRequested()
//     funderObj.acceptFundingRequest() //--- Accept Funding Request
//     funderObj.invoiceStateConfirmed() // - Invoice state -Confirmed
//     cy.reload();
//     funderObj.invoiceStatePendingSettlement() // Invoic state - Pending Settelement
